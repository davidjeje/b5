...
<html>
	...
	<title>connexion à la partie utilisateur</title>
			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>connexion à la partie utilisateur</h1>
				   				</div>
				   			</div>
				   				</div>
				   			</div>
								...
								<form class="form-inline qbstp-header-subscribe">
									<div class="row">
										...
										<div class="col-md-12 col-md-offset-0">
											<div class="form-group">
												<input type="text" class="form-control" id="pseudo" placeholder="Enter your pseudo" name="pseudo">
												<input type="text" class="form-control" id="email" placeholder="Enter your password" name="password">
