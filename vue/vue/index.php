                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 animate-box">
                        ...
                        <div class="row contact-info-wrap">
                            <div class="col-md-3">
                                <p><span><i class="icon-location-2"></i></span>Ile de France, <br> Seine et Marne</p>
                            </div>
                            <div class="col-md-3">
                                <p><span><i class="icon-phone3"></i></span> 06 06 78 45 93</p>
                            </div>
                            <div class="col-md-3">
                                <p><span><i class="icon-paperplane"></i></span> <a href="davidCV.PDF">CV</a></p>
                            </div>
                            <div class="col-md-3">
                                <p><span><i class="icon-linkedin"></i></span> <a href="https://www.linkedin.com">linkedin David Marivat</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-10 col-md-offset-1 animate-box">
