			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 animate-box">
						...
						<li><a href="index.php?page=ajouter">Ajouter un blog post</a></li>
						<li class="has-dropdown active"><a href="index.php?page=modif">Modifier un blog post</a></li>
						<li class="has-dropdown"><a href="index.php?page=supprimer">Suppprimer un blog post</a></li>
			...
			<div class="container">
                <div class="row row-pb-md">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="colorlib-footer-links">
                            <li>
                                <span><span><a href="index.php?page=vers_theme"><i class="icon-check"></i> click ici pour les visualiser</a></span></span>
                            </li>
