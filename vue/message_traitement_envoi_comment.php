			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2></h2>
				   					<h1>Validation de l'envoi des commentaires</h1>
				   				</div>
				   			</div>
				   				</div>
				   			</div>
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 animate-box">
						...
						<div class="row contact-info-wrap"> 
                            ...
                            <h3> Votre message à bien été transféré !!!</h3>
                            
                            	
                            	<p class="text-center"><a href="index.php?page=vers_liste_blog" class="btn btn-primary btn-custom">Cliquer ici pour revenir à la liste des blogs posts</a><p>
						</div>
					</div>
