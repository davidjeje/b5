...
<html>
	<head>
		...
		<title>Validation de la suppression d'un blog</title>
			   					...
			   					<div class="row">
				   					<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   						<div class="slider-text-inner text-center">
				   							<h1>Le blog est supprimé. Cliquer sur le lien gestion des blogs pour retourner sur la page d'acceuil de l'administrateur.</h1>
				   						</div>
				   					</div>
				   				</div>
				   			</div>
