				...
				<div class="row">
					<div class="content">
						...
						<article class="blog-entry">
							<div class="blog-wrap">
								<span class="category text-center"><a href="index.php?page=vers_le_blog&amp;id=<?=$read->id()?>"><h1> <?php echo$read->title()?>  </h1></a></span>
								<h2 class="text-center"><a href="blog.html"><h1> <?php echo$read->chapo()?>  </h1></a></h2>
								<div class="blog-image">
									<a href="index.php?page=vers_le_blog&amp;id=<?=$read->id()?>" class="blog-img text-center" style="background-image: url(<?php echo$read->image()?>)";><span><i class="icon-link"></i></span></a>
									<ul class="share">
								...
								<span class="category text-center"><a href="blog.html"><i class="icon-calendar3"></i> <?php echo$read->dateDisplay()?></a> | <a href="admin.php?id=.". class="posted-by"><i class="icon-user2"></i><h1> <?php echo $read->author()?> </h1></a> | <a href="blog.html"><i class="icon-bubble3"></i> </a></span>
							</div>
							<div class="desc">
					...
					<aside class="sidebar">
						...
						<div class="side-wrap">
							...
							<div class="author-img" style="background-image: url(public/images/avatar.png" alt="avatar david")";"></div>
